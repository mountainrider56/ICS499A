...
class PdfPcBackupManagementSpec extends Specification {
    ...
    def 'build'() {
        ...
        when:
        new PdfPcBackupManagement(quote, document, services, builder, totals)
        ...
        1 * builder.withRow('BackupManagementPC') >> builder
        1 * builder.withQuantitySubRow('BackupManagementMonitoringPC') >> builder
        1 * builder.withQuantitySubRow('BackupManagementIntegratedBackupPC') >> builder
